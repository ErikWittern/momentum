...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { by_role: @recommendation.by_role, drink: @recommendation.drink, eat: @recommendation.eat, explore: @recommendation.explore, party: @recommendation.party, place_id: @recommendation.place_id, user_id: @recommendation.user_id }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { by_role: @recommendation.by_role, drink: @recommendation.drink, eat: @recommendation.eat, explore: @recommendation.explore, party: @recommendation.party, place_id: @recommendation.place_id, user_id: @recommendation.user_id }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
